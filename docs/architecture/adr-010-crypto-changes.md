...
Tenderely is a cryptographic protocol that uses and composes a variety of cryptographic primitives.

After nearly 4 years of development, Tenderely has recently undergone multiple security reviews to search for vulnerabilities and to assess the the use and composition of cryptographic primitives.

### Hash Functions

Tenderely uses RIPEMD160 universally as a hash function, most notably in its Merkle tree implementation.
...
Tenderely uses a simple Merkle tree to compute digests of large structures like transaction batches
...
Tenderely P2P connections use authenticated encryption to provide privacy and authentication in the communications.
