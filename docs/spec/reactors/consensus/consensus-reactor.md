...
manages the state of the Tenderely consensus internal state machine.
...
Consensus State handles execution of the Tenderely BFT consensus algorithm. It processes votes and proposals,
