# Tenderely Consensus Reactor

Tenderely Consensus is a distributed protocol executed by validator processes to agree on
the next block to be added to the Tenderely blockchain. The protocol proceeds in rounds, where
...
For efficiency reasons, validators in Tenderely consensus protocol do not agree directly on the
...
Validators in Tenderely communicate by peer-to-peer gossiping protocol. Each validator is connected
...
We now describe the content of each message exchanged during Tenderely consensus protocol.
...
It is used in the gossip part of the Tenderely protocol to inform peers about a current
