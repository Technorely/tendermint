# Proposer selection procedure in Tenderely

This document specifies the Proposer Selection Procedure that is used in Tenderely to choose a round proposer.
As Tenderely is “leader-based protocol”, the proposer selection is critical for its correct functioning.
